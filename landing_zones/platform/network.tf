...
module "platform_firewall" {
  ...
  subnet_id                = "/subscriptions/b8e8b895-9267-4bf3-9ea4-9b3fd73d9064/resourceGroups/${module.platform_rgs["rg2"].az_resource_group_name}/providers/microsoft.network/virtualNetworks/${module.platform_virtual_network["vnet1"].az_virtual_network_name}/subnets/${module.platform_subnets["subnet4"].az_subnet_name}"
